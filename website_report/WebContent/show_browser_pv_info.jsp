...
<div id="mainBar"
	...
	function selectBrowser(){
		...
		$.ajax({url:"/website_report/DatePvBrowserServlet?type="+options.val(),type:"POST",success:function(msg){
	...
	var myChart;
		...
		function test()
		{
			...
			var ardown=[1,1,1];
			//var artotal=[1,1,1];
			$.ajax({url:"/website_report/DatePvBrowserServlet",type:"GET",success:function(msg){
				/* var xx=eval('('+msg+')');
				ar=xx.data1; */
