...
public class DateSessionDao {
	...
	public DateSessionDao (String type) {
		this.type = type;
	}
	...
	public DateSessionEntity getDateUserList() {
		...
		DateSessionEntity dateUserEntity = new DateSessionEntity();
		try {
			PreparedStatement ps = con.prepareStatement("select date,browsertype,ssnumber,ssduration,avgssduration "
					+ "from website_date_browser_session_count");
