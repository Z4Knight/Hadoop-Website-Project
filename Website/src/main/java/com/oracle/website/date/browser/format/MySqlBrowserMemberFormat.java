...
import com.oracle.website.date.browser.dao.BrowserMemberDao;
...
public class MySqlBrowserMemberFormat extends OutputFormat<DateBrowserDimention, VisitorsCountValue>{
	...
	public RecordWriter<DateBrowserDimention, VisitorsCountValue> getRecordWriter(TaskAttemptContext context)
		...
		BrowserMemberDao dao = new BrowserMemberDao();
